...
<section class="section primary latest-posts" id="s-latest-posts">
        <div class="container">
            <header class="sep active">
                ...
                <p class="sub-text">@lang('Read about upcoming projects, products or ideas and software solutions in genereal, follow us on') <a href="https://medium.com/@saly3301">Medium</a> @lang('to get notified!')</p>
            </header>
            <div class="row blog-items">
                ...
                <div class="span-4 blog-item">
                        ...
                        <p>{{ $article->excerpt }}</p>
                        <a class="button round brand-1" href="{{ route('article', ['article' => $article]) }}">@lang('Read More')</a>
