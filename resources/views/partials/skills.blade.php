	...
	<div class="container">
		<div class="row block-columns">
			<div class="span-6 skills-meta">
				...
				<p>We can provide <b>valuable services</b> on almost any software project regardless of the technology being used
					due to what we call <b>cross-platform skills</b>. However, there are of course some technologies we are more
					familiar with.</p>
				...
				<p class="button-set">
					...
					<a href="{{ route('about') }}" class="button round border">Read More</a>
				</p>
			</div>
