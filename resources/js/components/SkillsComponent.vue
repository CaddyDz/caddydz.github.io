<template>
  <section class="section secondary skills" :class="{inactive: !isActive, active: isActive}" id="s-skills" ref="section">
      <div class="container">
          <div class="row block-columns">
              <div class="span-6 skills-meta">
                  ...
                  <p>I can provide <b>valuable services</b> on almost any software project regardless of the technology being used due to what I call <b>cross-platform skills</b>. However, there are of course some technologies I am more familiar with.</p>
                  ...
                  <p class="button-set">
                      <a href="/contact" class="button round brand-1">Get in Touch</a>
